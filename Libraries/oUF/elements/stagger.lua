...
local function Visibility(self, event, unit)
	local element = self.Stagger
	if(SPEC_MONK_BREWMASTER ~= (C_SpecializationInfo and C_SpecializationInfo.GetSpecialization and C_SpecializationInfo.GetSpecialization() or (GetSpecialization and GetSpecialization())) or UnitHasVehiclePlayerFrameUI('player')) then
